...
def receiving_data(n):
    ...
    for x in res:
        ...
        dict = {'email':email, 'password':password, 'gender':gender, 'name_title':name_title,
                ...
                'postcode': postcode, 'latitude':latitude, 'longitude':longitude, 'username':username, 'age':age, 'phone':phone,'cell':cell,
                'nat':nat, 'password_md5':password_md5,'timezone_offset':timezone_offset, 'timezone_description':timezone_description, 'picture':picture}
        users.append(dict)

...
def database_creation():
    ...
    query = f'''CREATE TABLE IF NOT EXISTS registration_data (
...
REFERENCES users3 (user_id)
    ...
    query = f'''CREATE TABLE IF NOT EXISTS media_data (
...
REFERENCES users3 (user_id)
    ...
    query = f'''CREATE TABLE IF NOT EXISTS contact_details (
...
REFERENCES users3 (user_id)
    ...
    query = f'''CREATE TABLE IF NOT EXISTS cities (
